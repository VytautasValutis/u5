                ...
                <div class="card-header">
                    <h1>Edit client
                        <span class="edit-header-span">PID {{$client->pid}}
                            <button type="submit" class="btn btn-primary ms-4" form="client-edit-form">Submit</button>
                            <a href="" class="btn btn-primary ms-4">Add new account</a>
                        </span>
                    </h1>
                </div>
                <div class="card-body">
                    <form action="{{route('clients-update', $client)}}" method="post" id="client-edit-form">
                        <div class="mb-3">
